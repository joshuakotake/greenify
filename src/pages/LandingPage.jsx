        ...
        <div className="flex flex-col justify-center min-h-screen py-12">
          <div className="text-center">
            ...
            <p className="mt-6 text-xl text-gray-600 max-w-3xl mx-auto">
              Join a community of eco-conscious individuals. Track your
              emissions, compete with friends, and make a positive impact on the
              planet.
            </p>
            <div className="mt-10 flex justify-center gap-x-6">
              <Link
                to="/register"
                className="bg-green-600 hover:bg-green-700 text-white px-8 py-3 rounded-md text-lg font-medium shadow-lg"
              >
                Get Started
              </Link>
              <Link
                to="/login"
                className="bg-white hover:bg-gray-50 text-green-600 px-8 py-3 rounded-md text-lg font-medium border border-green-600 shadow-lg"
              >
                Sign In
              </Link>
            </div>
